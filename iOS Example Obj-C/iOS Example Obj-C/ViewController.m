...
//    PusherClientOptions *optionsWithEndpoint = [[PusherClientOptions alloc] initWithAuthMethod:endpointAuthMethod];
    ...
    self.client = [[Pusher alloc] initWithAppKey:@"1ef0aa923b0e32063ff8" options:options];
    ...
    PusherChannel *myChannel = [self.client subscribeWithChannelName:@"private-encrypted-OKP-channel"];
